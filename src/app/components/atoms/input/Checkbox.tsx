...
export const Checkbox = (props: typeCheckbox) => {
  ...
  return (
    ...
    <div className='relative'>
        <input type="checkbox" className='c-checkbox peer absolute w-full h-full top-0 left-0 opacity-0' name='search-genre' value={id} id={'search-genre-' + index} onChange={checkboxClick} checked={checked} aria-checked={checked} aria-label={`search-genre-${id}`} />
