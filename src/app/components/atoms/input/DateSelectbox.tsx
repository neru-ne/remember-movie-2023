...
export const DateSelectbox = (props: typeDateSelectbox) => {
  const { data,name, selectChange } = props;
  return (
    <select name={name} className="border border-black rounded-md  w-full block py-2.5 px-4" id="search-date" onChange={selectChange} defaultValue={props.data[0].date}>
